    ...
    public AExtracter(Category category, SlimefunItemStack item, String id, RecipeType recipeType, ItemStack[] recipe) {
        ...
        addItemHandler(new BlockBreakHandler(false,true) {
            ...
            public void onPlayerBreak(BlockBreakEvent blockBreakEvent, ItemStack itemStack, List<ItemStack> list) {
                BlockMenu inv = BlockStorage.getInventory(blockBreakEvent.getBlock());
                if (inv != null) {
                    for (int slot : getInputSlots()) {
                        if (inv.getItemInSlot(slot) != null) {
                            blockBreakEvent.getBlock().getWorld().dropItemNaturally(blockBreakEvent.getBlock().getLocation(), inv.getItemInSlot(slot));
                    ...
                    if (inv.getItemInSlot(40) != null) {
                        blockBreakEvent.getBlock().getWorld().dropItemNaturally(blockBreakEvent.getBlock().getLocation(), inv.getItemInSlot(40));
                        inv.replaceExistingItem(40, null);
                    }
                }

                progress.remove(blockBreakEvent.getBlock());
                processing.remove(blockBreakEvent.getBlock());
