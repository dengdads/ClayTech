...
public class ClayTech extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        Bukkit.getPluginManager().registerEvents(new ItemInteractListener(), plugin);
        Bukkit.getPluginManager().registerEvents(new ItemUseListener(), plugin);
        Bukkit.getPluginManager().registerEvents(new FoodEatListener(), plugin);
        Bukkit.getPluginManager().registerEvents(new FoodDropListener(), plugin);
        Bukkit.getPluginManager().registerEvents(new WeaponListener(), plugin);
        Bukkit.getPluginManager().registerEvents(new RailwayListener(), plugin);
        Bukkit.getPluginManager().registerEvents(new PlanetListener(), plugin);
        Bukkit.getPluginManager().registerEvents(new RocketLauncherListener(), plugin);
        Bukkit.getPluginManager().registerEvents(new PlanetBaseListener(), plugin);
        Bukkit.getPluginManager().registerEvents(new BlockUseListener(), plugin);
